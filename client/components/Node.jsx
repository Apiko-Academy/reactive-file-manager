...
Node = React.createClass({
    ...
    render() {
        ...
        return <li onMouseOver={this.handleMouseOver} onMouseOut={this.handleMouseOut} className={liClass}>
            <i className={iconClass}></i>&nbsp; <Link tabIndex="-1" to={file.relativePath}>{file.name}</Link></li>;
    }
});